...
const TermsAndConditions: React.FC = () => {
  return (
    <section className="max-w-3xl mx-auto my-16 p-8 bg-white rounded-2xl shadow-lg border border-emerald-100">
      <h1 className="text-3xl font-bold text-emerald-700 mb-2">Terms &amp; Conditions</h1>
      <p className="text-xs text-gray-400 mb-6">Last updated on 22-03-2026 23:02:04</p>
      <div className="space-y-4 text-slate-800 text-sm">
        <p>These Terms and Conditions, along with privacy policy or other terms (&quot;Terms&quot;) constitute a binding agreement by and between UTKARSH SHUKLA, ("Website Owner" or "we" or "us" or "our") and you ("you" or "your") and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, "Services").</p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Gurgaon, Haryana.</li>
